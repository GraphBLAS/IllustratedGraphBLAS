...
class Scene7(VoiceoverScene, Scene):
    def construct(self):
        ...
        with self.voiceover(
            ...
            merge with existing data. And vxm and mxv control traversal
            direction: forward along outgoing edges, or backward along
            incoming edges."""
        ):
            # Summary bullets
            summary = VGroup(
                ...
                Text("• vxm traverses forward, mxv traverses backward", font_size=28),
